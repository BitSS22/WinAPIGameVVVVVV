...
void V6ContentsCore::EnermyImageLoad()
{
	...
	UnitXCount = 4;
	UnitTotalCount = 4;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::064 Clock Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::065 Clock Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::066 Clock Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::067 Clock Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::068 Clock Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::069 Clock Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::070 Clock Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 2;
	UnitTotalCount = 2;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::071 Speaker Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::072 Speaker Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::073 Speaker Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::074 Speaker Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::075 Speaker Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::076 Speaker Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::077 Speaker Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 2;
	UnitTotalCount = 2;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::078 Factory Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::079 Factory Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::080 Factory Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::081 Factory Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::082 Factory Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::083 Factory Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::084 Factory Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 2;
	UnitTotalCount = 2;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::085 TV Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::086 TV Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::087 TV Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::088 TV Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::089 TV Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::090 TV Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::091 TV Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::092 TRUTH Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::093 TRUTH Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::094 TRUTH Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::095 TRUTH Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::096 TRUTH Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::097 TRUTH Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::098 TRUTH Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::099 LIES Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::100 LIES Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::101 LIES Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::102 LIES Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::103 LIES Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::104 LIES Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::105 LIES Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 4;
	UnitTotalCount = 4;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::106 Skull Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::107 Skull Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::108 Skull Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::109 Skull Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::110 Skull Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::111 Skull Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::112 Skull Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 2;
	UnitTotalCount = 2;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::113 Mannequin Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::114 Mannequin Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::115 Mannequin Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::116 Mannequin Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::117 Mannequin Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::118 Mannequin Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::119 Mannequin Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 4;
	UnitTotalCount = 4;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::120 Fish Right Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::121 Fish Right Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::122 Fish Right Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::123 Fish Right Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::124 Fish Right Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::125 Fish Right Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::126 Fish Right Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 4;
	UnitTotalCount = 4;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::127 Fish Left Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::128 Fish Left Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::129 Fish Left Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::130 Fish Left Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::131 Fish Left Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::132 Fish Left Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::133 Fish Left Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::134 0008 Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::135 0008 Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::136 0008 Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::137 0008 Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::138 0008 Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::139 0008 Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::140 0008 Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::141 8000 Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::142 8000 Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::143 8000 Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::144 8000 Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::145 8000 Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::146 8000 Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::147 8000 Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::141 Big Circle Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::142 Big Circle Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::143 Big Circle Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::144 Big Circle Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::145 Big Circle Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::146 Big Circle Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::147 Big Circle Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::148 Big Rectangle Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::149 Big Rectangle Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::150 Big Rectangle Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::151 Big Rectangle Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::152 Big Rectangle Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::153 Big Rectangle Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::154 Big Rectangle Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::155 Cloud Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::156 Cloud Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::157 Cloud Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::158 Cloud Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::159 Cloud Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::160 Cloud Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::161 Cloud Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	...
	UnitXCount = 1;
	UnitTotalCount = 1;
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::162 Chimney Cyan", FVector2D(StartPosX, StartPosY + ColorOffsetY * 0), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::163 Chimney Pink", FVector2D(StartPosX, StartPosY + ColorOffsetY * 1), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::164 Chimney Red", FVector2D(StartPosX, StartPosY + ColorOffsetY * 2), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::165 Chimney Blue", FVector2D(StartPosX, StartPosY + ColorOffsetY * 3), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::166 Chimney Yellow", FVector2D(StartPosX, StartPosY + ColorOffsetY * 4), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::167 Chimney Green", FVector2D(StartPosX, StartPosY + ColorOffsetY * 5), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
	UImageManager::GetInst().CreateCutSprite("Enemies.png", "Enemies::168 Chimney Grey", FVector2D(StartPosX, StartPosY + ColorOffsetY * 6), CuttingSize, FVector2D(6.f, 6.f), UnitXCount, UnitTotalCount);
